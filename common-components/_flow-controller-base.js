...
var transition_tl = new TimelineMax({ });	
...
$.extend(FlowControllerBase.prototype, {
    ...
    init:function()
    {
        ...
        // MAIN TIMELINE
				...
				tl
					...
					.from('#terms_cta', 0.5, {autoAlpha: 0}, label+"+=0.5")
    ...
    setupCommonElements:function()
    {
				...
				$('#subtitle1').html(adkit.getSVData("subtitle1"));
				...
				$('#subtitle5').html(adkit.getSVData("subtitle5"));
				...
				var image1 = adkit.getSVData("image1");
		
				document.getElementById("image1").src = EB.getAssetUrl("", image1);
    ...
    {
        console.log('Terms Mouse Over');
		TweenMax.to('#terms', 0.5, {y: -124});
		TweenMax.to('#terms_cta', 0.5, {autoAlpha: 0})
	},
	
	termsMouseOut: function()
    {
        console.log('Terms Mouse Out');
		TweenMax.to('#terms', 0.5, {y: 124});
