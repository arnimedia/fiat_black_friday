...
$.extend(FlowController.prototype, {
	...
	init:function()
    {
		...
		function car_tires(car, duration){
			...
			car_tl
				...
				.add('car_start')
				.to('.tire_spin'+car,1.5,{rotation:1440, ease:Power2.easeOut},'car_start')
				.to('.tire_spin'+car,.5,{rotation:1437,ease:Power2.easeInOut},'car_start+=1.5')
		...
		function transition(duration){
			...
			transition_tl
				...
				.to('#tr1', 0.5, {y: docHeight+150}, 'transition_out')
				.to('#tr2', 0.5, {y: -docHeight*2}, 'transition_out')
				.to('#tr3', 1.5, {y: docHeight+150}, 'transition_out')
				.to('#tr4', 2, {y: -docHeight*2}, 'transition_out')
				.to('#tr5', 1.2, {y: docHeight+150}, 'transition_out')
				.to('#tr6', 0.4, {y: -docHeight*2}, 'transition_out')
				.to('#tr7', 1.8, {y: docHeight+150}, 'transition_out')

				.to('#tr11', 1.5, {y: -docHeight*2}, 'transition_out')
				.to('#tr22', 2, {y: docHeight+150}, 'transition_out')
				.to('#tr33', 2.5, {y: -docHeight*2}, 'transition_out')
				.to('#tr44', 3, {y: docHeight+150}, 'transition_out')
				.to('#tr55', 2.5, {y: -docHeight*2}, 'transition_out')
				.to('#tr66', 2, {y: docHeight+150}, 'transition_out')
        ...
        // MAIN TIMELINE
				...
				tl.set(['#tr1','#tr3','#tr5','#tr7'], {y: docHeight+150});
				tl.set(['#tr2','#tr4','#tr6'], {y: -docHeight*2});
				tl.set(['#tr11','#tr33','#tr55','#tr77'], {y: -docHeight*2});
				tl.set(['#tr22','#tr44','#tr66'], {y: docHeight+150});
				...
				tl
					...
					.call(car_tires, ["1", "2"], this, label+"+=3.7") 
				...
				tl
					...
					.call(car_tires, ["2", "7.2"], this, label+"-=0.9") 
					...
					.call(transition, ["2.5"], this, label+"+=3.7") 	
				...
				tl
					...
					.call(car_tires, ["3", "12"], this, label+"-=0.9") 
					...
					.call(car_tires, ["3", "5"], this, label+"+=3.7") 
				...
				tl
					...
					// .set('#logo', {top: 61, left: 148}, label)
					.to('#logo', 0.5, {autoAlpha: 1}, label+"+=0.5")
				...
				tl
					...
					.to('#terms_cta', 0.5, {autoAlpha: 1}, label+"+=0.5")
    ...
    {
        console.log('Terms Mouse Over 728x90');
		TweenMax.to('#terms', 0.5, {autoAlpha: 1, y: -60});
		TweenMax.to('#terms_cta', 0.5, {autoAlpha: 0})
	},
	
	termsMouseOut: function()
    {
        console.log('Terms Mouse Out 728x90');
		TweenMax.to('#terms', 0.5, {autoAlpha: 0, y: 90});
		TweenMax.to('#terms_cta', 0.5, {autoAlpha: 1})
    },
